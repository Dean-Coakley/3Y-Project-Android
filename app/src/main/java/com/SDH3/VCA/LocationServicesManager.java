...
public class LocationServicesManager implements LocationListener {
    ...
    private boolean setupUpdateRequests(LocationManager lm){
        ...
        try {
            ...
            if(isGPSEnabled) {
                // the more intensive location requests are done less often.
                this.locMan.requestLocationUpdates(LocationManager.GPS_PROVIDER, 30000, 10, this);
                this.locMan.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 15000, 10, this);
                this.locMan.requestLocationUpdates(LocationManager.PASSIVE_PROVIDER, 5000, 10, this);
                return true;
            }else{
                Toast.makeText(currentContext,
    ...
    public Location getLastLocation(){
        ...
        boolean initSuccess;
        if (locMan == null) initSuccess = locationManagerInit();
        ...
        if (!updatesRequested && initSuccess) {
